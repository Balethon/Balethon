...
class LoadFullUsers(_message.Message):
    __slots__ = ("full_users",)
    FULL_USERS_FIELD_NUMBER: _ClassVar[int]
    full_users: _containers.RepeatedCompositeFieldContainer[_struct_pb2.FullUserLegacy]
    def __init__(self, full_users: _Optional[_Iterable[_Union[_struct_pb2.FullUserLegacy, _Mapping]]] = ...) -> None: ...
