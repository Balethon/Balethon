from ..structs import struct_pb2 as _struct_pb2
...
class StartPhoneAuth(_message.Message):
    ...
    is_registered: bool
    sent_code_type: int
    code_expiration_date: _struct_pb2.Int64Value
    next_send_code_type: int
    next_send_code_wait_time: _struct_pb2.Int64Value
    code_timeout: _struct_pb2.Int32Value
    def __init__(self, transaction_hash: _Optional[str] = ..., is_registered: bool = ..., sent_code_type: _Optional[int] = ..., code_expiration_date: _Optional[_Union[_struct_pb2.Int64Value, _Mapping]] = ..., next_send_code_type: _Optional[int] = ..., next_send_code_wait_time: _Optional[_Union[_struct_pb2.Int64Value, _Mapping]] = ..., code_timeout: _Optional[_Union[_struct_pb2.Int32Value, _Mapping]] = ...) -> None: ...
